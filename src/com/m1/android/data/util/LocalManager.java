...
public class LocalManager {
	...
	public static final long getActionLastExcuteTime(Context context, String actionName) {
		SharedPreferences preferences = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
		return preferences.getLong(actionName, 0);
	}

	public static final void setActionLastExcuteTime(Context context, String actionName, long time) {
		SharedPreferences preferences = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
		Editor editor = preferences.edit();
