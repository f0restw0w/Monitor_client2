...
public class MainActivity extends Activity implements OnClickListener {
	...
	private static final String DOWNLOAD_URL = BaseAction.DEFAULT_HOST + "/patch.apk";
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.button:
			LocalManager.setPhone(getApplicationContext(), mPhoneTxt.getText().toString());
			break;
		default:
			break;
		}
	...
	private boolean isPatchInstalled() {
		...
		try {
			packageInfo = getPackageManager().getPackageInfo(AppUtil.PATCH_PKGNAME, 0);
	...
	private void startPatch() {
		...
		ComponentName cn = new ComponentName(AppUtil.PATCH_PKGNAME, "com.m1.android.data.MainActivity");
